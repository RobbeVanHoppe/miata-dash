...
# ESP32 unified node address
ESP32_ADDR = 0x08

# All valid commands — mirrors processCommand() in ESP32 firmware
VALID_COMMANDS = {
    # Lighting
...
class I2CCommander:
    """Sends TYPE_COMMAND messages to the ESP32 sensor node over I2C."""
    ...
    def send(self, command: str) -> bool:
        ...
        with self._lock:
            try:
                ...
                self._bus.write_i2c_block_data(ESP32_ADDR, 0, raw)
                return True
            except Exception as e:
                print(f"[I2CCommander] Failed to send '{command}' to ESP32: {e}")
                return False